...
output "mlops-demo_batch_inference_job_id" {
...
output "mlops-demo_experiment_id" {
  value = databricks_mlflow_experiment.experiment.id
}

output "mlops-demo_experiment_name" {
...
output "mlops-demo_training_job_id" {
