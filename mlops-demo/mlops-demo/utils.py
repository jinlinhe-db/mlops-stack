...
def _get_ml_config_value(env, key):
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"mlops-demo have been deployed to {env} (see mlops-demo"
...
def get_model_name(env, test_mode=False):
    ...
    if env == "dev" or test_mode:
        ...
        return f"mlops-demo-model{resource_name_suffix}"
    else:
        # Read ml model name from mlops-demo/terraform
        return _get_ml_config_value(env, "mlops-demo_model_name")
