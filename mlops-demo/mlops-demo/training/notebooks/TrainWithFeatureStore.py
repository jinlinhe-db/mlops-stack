...
# It is configured and can be executed as a training-job.tf job defined under ``mlops-demo/terraform``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"//mlops-demo-{env}/mlops-demo-experiment-test",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "mlops-demo-model-test", label="Model Name"
)
