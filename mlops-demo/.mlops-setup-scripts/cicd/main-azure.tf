resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "mlops-demo-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "mlops-demo-cicd"
  project_directory_path       = "/mlops-demo"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "mlops-demo-service-principals"
}
