...
[ML Config](../mlops-demo/terraform/README.md) guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore .mlops-setup-scripts mlops-demo/terraform/README.md
...
We recommend including all files outside of `mlops-demo/terraform` in this PR:
...
Follow the instructions in [mlops-demo/terraform/README.md](../mlops-demo/terraform/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mlops-demo/terraform/README.md) to propose, test, and deploy
